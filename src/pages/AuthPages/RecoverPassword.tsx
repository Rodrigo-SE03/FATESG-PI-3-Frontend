...
// ---- Helpers de senha (mesmos da página SignUp) ----
...
const RecoverPassword = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>) => {
    ...
    if (!code || !username) {
      setErrorMessage("Parâmetros de recuperação inválidos.");
      return;
    }
    ...
    try {
      ...
      console.error(err);
      const msg =
        err?.message || "Erro ao redefinir senha. Verifique o código e tente novamente.";
      setErrorMessage(msg);
    }
  };
